...
# pkpath = "C:/Users/TibeMe_user/Desktop/Python與LINE Bot機器人全面實戰特訓班--Flask最強應用學習資源/本書範例/ch02/packages"
# modelpath = r"C:\Users\TibeMe_user\Desktop\Python與LINE Bot機器人全面實戰特訓班--Flask最強應用學習資源\本書範例\ch02\model_1"
modelpath = "./model_1"
...
def convert_data_to_feature(tokenizer, train_data_path):
    ...
    output = open(modelpath + r'\data_features.pkl', 'wb')
...
def predicttext(inputs):
    pkl_file = open(modelpath + r"\data_features.pkl", 'rb')
    data_features = pickle.load(pkl_file)
    answer_dic = data_features['answer_dic']
    # BERT
    model_setting = {
        "model_name":"bert", 
        "config_file_path":modelpath +r"\config.json",
        "model_file_path":modelpath + r"\pytorch_model.bin",
